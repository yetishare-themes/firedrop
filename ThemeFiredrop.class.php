...
use Themes\Firedrop\ThemeConfig;

class ThemeFiredrop extends Theme
{
    ...
    public function registerRoutes(\FastRoute\RouteCollector $r) {
        ...
        $r->addRoute(['GET', 'POST'], '/upgrade[/{packageId:[0-9]+}]', '\themes\\'.$this->config['folder_name'].'\controllers\IndexController/upgrade');
		 $r->addRoute(['GET', 'POST'], '/signup[/{packageId:[0-9]+}]', '\themes\\'.$this->config['folder_name'].'\controllers\IndexController/signup');
       ...
       $r->addRoute(['GET', 'POST'], '/network_status', '\themes\\'.$this->config['folder_name'].'\controllers\IndexController/networkStatus');
